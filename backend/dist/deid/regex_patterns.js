...
exports.detectEntitiesWithRegex = detectEntitiesWithRegex;
const entity_filters_1 = require("./entity_filters");
function detectEntitiesWithRegex(text, enabledTypes, customMaskList) {
    const entities = [];
    ...
    filteredEntities = (0, entity_filters_1.filterFalsePositives)(filteredEntities, text);
    filteredEntities = (0, entity_filters_1.mergeOverlappingEntities)(filteredEntities);
    filteredEntities = (0, entity_filters_1.enhanceEntitiesWithContext)(filteredEntities, text);
    return filteredEntities;
}
function isCommonOrganizationOrLocation(name) {
    const commonWords = [
...
function removeDuplicateEntities(entities) {
    ...
    for (const entity of sorted) {
        const overlaps = result.some((e) => (entity.start >= e.start && entity.start < e.end) ||
...
//# sourceMappingURL=regex_patterns.js.map